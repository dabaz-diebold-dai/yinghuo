    ...
    <div className="relative isolate overflow-hidden bg-neutral-900 py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">联系我们</h2>
          <p className="mt-6 text-lg leading-8 text-neutral-300">
            欢迎您访问映火文化传媒的“联系我们”页面。无论您有任何疑问、建议或合作意向，我们都非常欢迎您的反馈和联系。映火始终致力于为客户提供优质服务和专业的摄影器材。在映火，我们始终相信沟通是建立长期合作关系的基础。您的每一次咨询对我们都至关重要，我们期待着听到您的声音，并承诺尽快给予回应。
          </p>
        </div>
      </div>
    </div>
